...
/* LED pins */
#define LED_BLINK_PIN MCU_GPIO_PORTA(3)
   
/* SX1276 pins / SPI defined in syscfg.yml */
// PA14 used as not connected!
#define MCU_GPIO_NC		MCU_GPIO_PORTA(14)
#define SX1276_DIO0		MCU_GPIO_PORTA(13)
#define SX1276_DIO1		MCU_GPIO_PORTA(12)
#define SX1276_DIO2		MCU_GPIO_NC
#define SX1276_DIO3		MCU_GPIO_NC
#define SX1276_DIO4		MCU_GPIO_NC
#define SX1276_DIO5		MCU_GPIO_NC
#define SX1276_NRESET		MCU_GPIO_PORTA(11)
#define SX1276_RXTX		MCU_GPIO_NC
#define SX1276_ANT_HF_CTRL	MCU_GPIO_NC
